					...
					<div>
						<div className='my-4'>
							{loading ? (
								...
								<div className='flex items-center justify-center h-24 w-20 rounded-md ring-2 ring-blue-500'>
									<ScaleLoader color='blue' />
								</div>
							) : (
								// Show the uploaded image or the default avatar
								<img
									src={pic || '/img_placeholder.jpg'}
									alt='user avatar'
									className='rounded-md ring-2 w-36  ring-blue-500'
								/>
							)}
						</div>
