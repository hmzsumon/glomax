...
const Referral = () => {
	...
	return (
		<Layout>
			<div className='referral-wrapper py-20'>
				<div className='overlay'></div>
				<div className='content '>
					<div className='px-4  md:w-7/12 mx-auto '>
						<div className='grid items-center gap-6 py-2 '>
							<div className='p-8  w-full bg-black_2 rounded-xl'>
								...
								<div className='space-y-10 '>
									...
									<div className='flex items-center grid-cols-8 gap-4 '>
										<div className='relative flex-1 col-span-7 p-4 bg-yellow-600 rounded-xl'>
